    ...
    <div class="section-bidding border-primary mb-5 mt-5">
        <div class="d-flex justify-content-between flex-wrap">
            <div class="d-flex col-sm-12 col-md-8 section-bidding-list">
                <h1><i class="fas fa-gavel mr-2"></i>Portarias</h1>
            </div>
        ...
        <div class="collapse" id="collapseExample">
            <div class="container mt-4">
                <form action="<?= url("/portarias/buscar");?>" method="POST">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-lg-3">
                            <label for="date-one"><strong>Data de pub. inicial</strong></label>
                            <input id="date-one" name="datePrevious" type="date" class="form-control input-date">
                        </div>
                        <div class="form-group col-sm-12 col-md-6 col-lg-3">
                            <label for="date-two"><strong>Data de pub. final</strong></label>
                            <input id="date-two" name="dateLater" type="date" class="form-control input-date">
                        </div>
                    </div>
...
<?php if (!empty($ordinance) && isset($ordinance)) : ?>
        <?php foreach ($ordinance as $item) : ?>
            <div class="col-12 my-4">
                <div class="card border border-primary">
                    <div class="card-header bg-primary">
                        <h5 class="text-white text-monospace bidding-process">
                            Portaria N° <?= $item->number_ordinance; ?>
                        </h5>
                       
                    </div>
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><strong class="mr-2">Portaria:</strong><?= $item->ordinance; ?></li>
                            <li class="list-group-item"><strong class="mr-2">Publicado em:</strong><?= date_fmt($item->created_at, "d/m/Y"); ?></li>
