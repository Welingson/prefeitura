    ...
    <div class="col-12 my-4">
        <div class="card border border-primary">
            <div class="card-header bg-primary d-flex justify-content-between flex-wrap">
                <h5 class="text-white text-monospace bidding-process bidding-process">Portaria
                    N° 01</h5>
                <span class="text-white font-weight-bold">09/03/2020</span>
            </div>
            <div class="card-body">
                <p class="text-justify"><strong>Portaria: </strong>Decreto qdhsdfdfb</p>
                <hr>
                <p><strong>Anexo da Portaria:</strong></p>
